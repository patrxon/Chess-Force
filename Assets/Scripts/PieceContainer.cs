...
public class PieceContainer
{
    ...
    List<Vector2Int> dirList = new List<Vector2Int> {new Vector2Int(1, 1), new Vector2Int(1, 0), new Vector2Int(1, -1), new Vector2Int(0, -1) ,
    ...
    public List<Vector2Int> LineMoveCreator(string length, int side)
    {
        ...
        for (int dir = 0; dir < 8; dir++)
        {
            ...
            {
                pointList.Add(dirList[dir] * new Vector2Int(1, side) * j);
            }
        }
